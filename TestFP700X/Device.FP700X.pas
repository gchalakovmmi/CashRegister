...
type
  ...
  private
    ...
    class function CheckTimeDifference: Integer;
...
class function TFP700X.CheckTimeDifference: Integer;
var
  LResult: Integer;
  ...
  begin
    ...
    if Assigned(FP700X) then begin
      try
        if FP700X.connected_ToDevice then begin
          if FP700X.execute_Command_ByName('062_info_Get_DateTime_01') = 0 then begin
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Day', LDay);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Month', LMonth);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Year', LYear);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Hour', LHour);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Minute', LMinute);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'Second', LSecond);
            FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'DST', LDST);
        ...
        LResult := FP700X.lastError_Code;
        FP700X.get_OutputParam_ByName('062_info_Get_DateTime_01', 'ErrorCode', LErrorCode);
      end;
    end;
    Exit(LResult);
  end;
  ...
  begin
    ...
    if Assigned(FP700X) then begin
      try
        if FP700X.connected_ToDevice then begin
          if FP700X.set_InputParam_ByName('061_config_Set_DateTime', 'DateTime', LDateTime ) = 0 then begin
            FP700X.execute_Command_ByName('061_config_Set_DateTime');
            LResult := 0;
          end;
        end;
      finally
        LResult := FP700X.lastError_Code;
        FP700X.get_OutputParam_ByName('061_config_Set_DateTime', 'ErrorCode', LErrorCode);
      end;
    end;
    Exit(LResult);
  end;
