...
begin
  ...
  if not
    (MessageDlg(
      Format('œÓÚ‚˙‰ÂÚÂ ÒÚÓÌË‡ÌÂ Ì‡ %s Ì‡ ÒÚÓÈÌÓÒÚ %.2f' + TAppSettings.GetSetting('MainCurrency'), [ASaleDetail.ItemName, ASaleDetail.Total.ToDouble]),
      mtConfirmation,
      [mbYes, mbNo],
      0,
      mbYes
...
begin
  ...
  if not
    (MessageDlg(
      Format('œÓÚ‚˙‰ÂÚÂ ÒÚÓÌË‡ÌÂ Ì‡ ÔÓ‰‡Ê·‡ Ì‡ ÒÚÓÈÌÓÒÚ %.2f' + TAppSettings.GetSetting('MainCurrency'), [FSale.Due.ToDouble]),
      mtConfirmation,
      [mbYes, mbNo],
      0,
      mbYes
