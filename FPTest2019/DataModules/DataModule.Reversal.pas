...
type
  TDataModuleReversal = class(TDataModule)
...
var
  DataModuleReversal: TDataModuleReversal;
...
procedure TDataModuleReversal.FDMemTableSaleAfterScroll(DataSet: TDataSet);
begin
...
function TDataModuleReversal.GetCurrentSaleDetailGID: String;
begin
  Result := '-1';
...
procedure TDataModuleReversal.SetupReversal(const ASale: IModelClassSale);
begin
...
procedure TDataModuleReversal.OpenSale(const ASale: IModelClassSale);
begin
...
procedure TDataModuleReversal.RegistrationOfSale(const ASaleDetail: IModelClassSaleDetail);
begin
  FDMemTableSaleDetails.DisableControls;
...
procedure TDataModuleReversal.RegistrationOfCancelation(const ASaleCancellation: IModelClassSaleCancellation);
begin
...
procedure TDataModuleReversal.Totals(const ASale: IModelClassSale);
begin
...
procedure TDataModuleReversal.CloseSale(const ASale: IModelClassSale);
begin
  FDMemTableSale.DisableControls;
  FDMemTableSale.Close;
  FDMemTableSale.CreateDataSet;
...
procedure TDataModuleReversal.DiscardSale(const ASale: IModelClassSale);
begin
  FDMemTableSale.DisableControls;
  FDMemTableSale.Close;
  FDMemTableSale.CreateDataSet;
...
procedure TDataModuleReversal.UpdateSalePayments(const ASale: IModelClassSale);
begin
  if FDMemTableSale.State in [dsEdit, dsInsert] then FDMemTableSale.Post;
  FDMemTableSale.Edit;
...
procedure TDataModuleReversal.RefreshData(const ADate: TDate);
var
  LFolderName: String;
