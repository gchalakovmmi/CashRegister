...
type
  TDataModuleSale = class(TDataModule)
    ...
    FDMemTableSaleReceiptID: TStringField;
    FDMemTableSalePaymentsDue: TStringField;
  ...
  public
    ...
    procedure ReloadSale(const ASale: IModelClassSale);
    ...
    procedure CompleteTotals(const ASale: IModelClassSale);
...
procedure TDataModuleSale.ReloadSale(const ASale: IModelClassSale);
var
...
begin
  ...
  FDMemTableSaleDetails.Close;
  FDMemTableSaleDetails.CreateDataSet;
  for LDetail in ASale.Details.List do begin
    LDetail.UpdateInDataSet;
  end;
  FDMemTableSaleDetails.Filtered := False;
  FDMemTableSaleDetails.EnableControls;
  FDMemTableSaleDetails.First;
...
procedure TDataModuleSale.CompleteTotals(const ASale: IModelClassSale);
begin
