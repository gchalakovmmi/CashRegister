...
begin
	...
	try
		...
		case cbx_PrinterModel.ItemIndex of
			...
			6: Result := dt_SK_31F_KL; // SK-31F KL
			7: Result := dt_FP_1000_KL;
			8: Result := dt_FMP10_KL; // FMP-10 KL
			9: Result := dt_FP_750_KL;
			10: Result := dt_WP500_KL;
			11: Result := dt_FMP350_KL;
		end;
	except
		Result := dt_Unknown;
	end;
			...
			case MyFiscDevice of
				...
				dt_FP_750_KL:
					begin
						...
						FP_705_KL.set_CommunicationRS232Values(CALC_COMNUM, StrToInt(cbx_Baudrate.Text), 2);
				...
				dt_WP500_KL:
					begin
						...
						WP_500_KL.set_CommunicationRS232Values(CALC_COMNUM, StrToInt(cbx_Baudrate.Text), 2);
	...
	try
		try
			...
			case MyFiscDevice of
				...
				dt_FP_750_KL: tmp_Int := FP_705_KL.command_Variant4(74);
	...
	try
		try
			...
			case MyFiscDevice of
				...
				dt_FP_750_KL: tmp_Int := FP_705_KL.command_048(1, OpPwd, 1, '', ErrorCode, tmp_IAnswer1);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_092(1, ErrorCode);
...
begin
	...
	try
		case MyFiscDevice of
			...
			dt_FP_750_KL: Result := Assigned(FP_705_KL);
				...
				begin
					...
					case MyFiscDevice of
						...
						dt_FMP10_KL: Result := FMP10_KL.CMD_49_0_0( //
								...
								GetParam(MY_PARAMS, 5),           //
								GetParam(MY_PARAMS, 6));          //
						dt_FP_750_KL: Result := FP_705_KL.command_049('Plu name', 2, '0.10', '', 0, '0.00', 0, ErrorCode, tmp_IAnswer1);
			...
			1:
				begin
					...
					case MyFiscDevice of
						...
						dt_FP_750_KL: Result := FP_705_KL.command_049('Plu name', 2, '0.10', '1.245', 0, '0.00', 0, ErrorCode, tmp_IAnswer1);
						dt_WP500_KL: Result := WP_500_KL.command_049('Plu name', 2, '0.10', '', 0, '0.00', 0, ErrorCode, tmp_IAnswer1);
						dt_FMP350_KL: Result := FMP_350KL.command_049('Plu name', 2, '0.10', '', 0, '0.00', 0, ErrorCode, tmp_IAnswer1);
					end;
				end;
	...
	try
		...
		begin
			...
			case MyFiscDevice of
				...
				dt_FP_750_KL: tmp_Int := FP_705_KL.command_051(1, 1, 1, '1.00', ErrorCode, tmp_IAnswer1, out_Subtotal, tax1_Sum, tax2_Sum, tax3_Sum, tax4_Sum, tax5_Sum, tax6_Sum, tax7_Sum, tax8_Sum);
		...
		begin
			...
			case MyFiscDevice of
				...
				dt_FMP10_KL: tmp_Int := FMP10_KL.CMD_51_0_1(Perc, SubTotal, TaxA, TaxB, TaxC, TaxD, TaxE, TaxF, TaxG, TaxH);
				dt_FP_1000_KL: tmp_Int := FP1000_KL.CMD_51_0_1(ToPrint, ToDisplay, Perc, SubTotal, TaxA, TaxB, TaxC, TaxD, TaxE, TaxF, TaxG, TaxH);
				dt_FP_750_KL: tmp_Int := FP_705_KL.command_051(1, 1, 2, '98.00', ErrorCode, tmp_IAnswer1, out_Subtotal, tax1_Sum, tax2_Sum, tax3_Sum, tax4_Sum, tax5_Sum, tax6_Sum, tax7_Sum, tax8_Sum);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_053_v001(0, '10.00', ErrorCode, tmp_WAnswer1, tmp_WAnswer2);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_056(ErrorCode, tmp_IAnswer1);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_054(TRGT_TEXT, ErrorCode);
	...
	begin
		...
		try
			case MyFiscDevice of
				...
				dt_FP_750_KL: Result := FP_705_KL.get_StatusBitState(i, j);
...
begin
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: Result := Result + FP_705_KL.last_ErrorMessage;
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_060(ErrorCode);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_039(ErrorCode, tmp_IAnswer1);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_038(ErrorCode, tmp_IAnswer1);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_042(TRGT_TEXT, ErrorCode);
	...
	var
		...
		begin
			case MyFiscDevice of
				...
				dt_FP_750_KL: Result := FP_705_KL.get_StatusBitDescription(i, j);
...
begin
	...
	try
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_071(0, ErrorCode);
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_088(StrToInt(Dept), ErrorCode, TaxGr, tmp_WAnswer2, TotSales, TotSum, Line1);
		...
		begin
			...
			case MyFiscDevice of
				dt_FP_750_KL: tmp_Str := tmp_Str + 'ExitCode: ' + IntToStr(ErrorCode) + cNewLine;
...
begin
	...
	try
		...
		case MyFiscDevice of
			...
			dt_FP_750_KL: tmp_Int := FP_705_KL.command_049('Plu name', 2, '0.01', '1.245', 0, '0.00', 0, ErrorCode, tmp_IAnswer1);
