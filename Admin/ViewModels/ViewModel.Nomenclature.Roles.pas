unit ViewModel.Nomenclature.Roles;
...
uses
  ...
  function CreateViewModelNomenclatureRoles: IViewModelNomenclatureRoles;
...
uses
  ...
  View.Nomenclature.Role,
  DataModule.Roles;

type
  TViewModelNomenclatureRoles = class(TInterfacedObject, IViewModelNomenclatureRoles)
...
procedure TViewModelNomenclatureRoles.ProcessNotification(const AModelNotification: IModelNotification);
begin
//
end;

procedure TViewModelNomenclatureRoles.SendNotification(const AInterfaceActions: TInterfaceActions);
var
...
function TViewModelNomenclatureRoles.GetObserver: IObserver;
begin
  Result := FObserver;
end;

function TViewModelNomenclatureRoles.GetObservable: IObservable;
begin
  Result := FObservable;
end;
...
function TViewModelNomenclatureRoles.GetGUIRecord(const AWidth: Integer): TViewNomenclatureRolesGUIRecord;
var
  LSpaces: Integer;
begin
...
procedure TViewModelNomenclatureRoles.Attach;
begin
  ShowViewNomenclatureRole(amdAttach);
  SendNotification([actUpdateGUI]);
end;

procedure TViewModelNomenclatureRoles.Modify;
begin
  ShowViewNomenclatureRole(amdModify);
  SendNotification([actUpdateGUI]);
end;

procedure TViewModelNomenclatureRoles.Detach;
begin
  ShowViewNomenclatureRole(amdDetach);
  SendNotification([actUpdateGUI]);
end;

procedure TViewModelNomenclatureRoles.CloseForm;
begin
...
constructor TViewModelNomenclatureRoles.Create;
begin
...
destructor TViewModelNomenclatureRoles.Destroy;
begin
//
  inherited;
end;
...
function CreateViewModelNomenclatureRoles: IViewModelNomenclatureRoles;
begin
  Result := TViewModelNomenclatureRoles.Create;
end;
