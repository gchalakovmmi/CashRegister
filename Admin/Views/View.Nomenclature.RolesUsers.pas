unit View.Nomenclature.RolesUsers;
...
type
  TViewNomenclatureRolesUsers = class(TForm)
    DBGrid: TDBGrid;
    Panel: TPanel;
  ...
  private
    FObserver: IObserver;
    FViewModel: IViewModelNomenclatureRolesUsers;
  {$ENDREGION}
...
//    property Observer: IObserver read FObserver;
    property ViewModel: IViewModelNomenclatureRolesUsers read FViewModel;
  {$ENDREGION}
  ...
  procedure ShowViewNomenclatureRolesUsers;
...
uses
  ...
  ViewModel.Nomenclature.RolesUsers,
  DataModule.RolesUsers;

{$REGION 'Published Methods'}

procedure TViewNomenclatureRolesUsers.FormCreate(Sender: TObject);
begin
  FObserver := CreateObserverClass;
  FObserver.SetUpdateObserverMethod(ProcessNotification);

  FViewModel := CreateViewModelNomenclatureRolesUsers;
  FViewModel.Observable.Subscribe(FObserver);

  UpdateGUI;
end;

procedure TViewNomenclatureRolesUsers.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
end;

procedure TViewNomenclatureRolesUsers.FormResize(Sender: TObject);
begin
  UpdateGUI;
end;

procedure TViewNomenclatureRolesUsers.SpeedButtonAttachClick(Sender: TObject);
begin
  ViewModel.Attach;
end;

procedure TViewNomenclatureRolesUsers.SpeedButtonModifyClick(Sender: TObject);
begin
  ViewModel.Modify;
end;

procedure TViewNomenclatureRolesUsers.SpeedButtonDetachClick(Sender: TObject);
begin
  ViewModel.Detach;
end;

procedure TViewNomenclatureRolesUsers.SpeedButtonExitClick(Sender: TObject);
begin
  Close;
end;
...
procedure TViewNomenclatureRolesUsers.ProcessNotification(const AModelNotification: IModelNotification);
begin
...
procedure TViewNomenclatureRolesUsers.UpdateGUI;
var
  LGUIRecord: TViewNomenclatureRolesUsersGUIRecord;
begin
...
procedure ShowViewNomenclatureRolesUsers;
var
  LViewNomenclatureRolesUsers: TViewNomenclatureRolesUsers;
begin
  LViewNomenclatureRolesUsers := TViewNomenclatureRolesUsers.Create(Application.MainForm);
  LViewNomenclatureRolesUsers.Show;
end;
