...
type
  ...
  public
    ///<sumarry>системен номер на анулирането, присвоен от софтуера</summary>
...
begin
  ...
  CancellationDate := (AJSONObject.GetValue('CancellationDate') as TJSONString).Value;
  CancellationTime := (AJSONObject.GetValue('CancellationTime') as TJSONString).Value;
