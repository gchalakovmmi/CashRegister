...
begin
  FBrand := AValue;
  Name := FBrand + ' ' + FModel + ' (' + FSerialNumber + ')';
end;
...
constructor TModelClassFiscalDevice.Create;
begin
  inherited Create;
  GID := TGeneratorGIDs.NewGIDByName('FiscalDeviceGID').ToString;
end;
...
function CreateFromDataSetModelClassFiscalDevice: IModelClassFiscalDevice;
begin
  Result := TModelClassFiscalDevice.CreateFromDataSet;
end;
