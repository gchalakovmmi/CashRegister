...
type
  ...
  TModelClassMeasures = class(TModelClassBaseCollection<IModelClassMeasure>, IModelClassMeasures)
...
function CreateFromFileModelClassMeasures: IModelClassMeasures;
begin
  Result := TModelClassMeasures.CreateFromFile;
end;

function CreateFromFileModelClassMeasures(const AFileName: String): IModelClassMeasures;
begin
  Result := TModelClassMeasures.CreateFromFile(AFileName);
end;
