...
type
  ...
  public
    ...
    constructor CreateFromFile; overload; virtual;
    constructor CreateFromFile(const AFileName: String); overload; virtual;
...
begin
  ABaseObject.AttachedAt := FormatDateTime('dd.mm.yyyy hh:nn:ss', Now);
  ABaseObject.ModifiedAt := FormatDateTime('dd.mm.yyyy hh:nn:ss', Now);
  List.Add(ABaseObject);
end;

procedure TModelClassBaseCollection<IBaseObject>.Detach(const ABaseObject: IBaseObject);
begin
  ABaseObject.DetachedAt := FormatDateTime('dd.mm.yyyy hh:nn:ss', Now);
end;
